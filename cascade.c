...
float p_value=2.6,d_value=25, i_value=0.015;//Adjust these values
float pid_i_roll=0,pid_i_pitch=0;

float p_value2=3.1, d_value2=25, i_value2=0.04;//Adjust these values
...
int main(void)
{
	...
	while(1)
	{
		...
		sprintf(AChar,"%i,%i,%i,%i\n",(int)(p_value*roll_error+p_value*pitch_error),(int)(pid_i_roll+pid_i_pitch),(int)(d_value*(roll_error-last_roll_error)+d_value*(pitch_error-last_pitch_error)),(int)(roll_rate_error+pitch_rate_error));
